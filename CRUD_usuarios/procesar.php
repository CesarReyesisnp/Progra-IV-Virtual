    ...
    class Usuario{
        ...
        private function validar_datos(){
            if( empty($this->datos['usuario']) ){
                $this->resp['msg'] = 'Por favor ingrese un USUARIO';
            } 
            if( empty($this->datos['clave']) ){
                $this->resp['msg'] = 'Por favor ingrese un CLAVE';
            }
            if( empty($this->datos['nombre']) ){
                $this->resp['msg'] = 'Por favor ingrese su NOMBRE';
            }
        ...
        private function administrar_usuario(){
            ...
            if( $this->resp['msg']=='OK' ){
                if( $accion=='nuevo' ){
                    ...
                    return $this->db->consultas('
                        UPDATE usuarios SET usuario=?, clave=?, nombre=?
